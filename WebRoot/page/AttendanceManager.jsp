  ...
  <body>
	 <div class="container-fluid">  
        <div id="toolbar" class="btn-group">  
            ...
            <!-- <button type="button" class="btn-info">导入excel</button>
            <button type="button" class="btn-success">导出全部</button> -->
        </div>  
                   ...
                   <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">添加考勤记录</h4>
                            </div>
