  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">大学生日常行为管理系统</span> 
			<a class="header-menu-btn" href="javascript:;"><i class="icon-font">&#xe600;</i></a>
			<ul class="header-bar">
				<li class="header-bar-role"><a href="javascript:;">超级管理员</a></li>
				<li class="header-bar-nav">
					<a href="javascript:;"><%= session.getAttribute("loginName")%><i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
		...
		<div class="layout-footer">@2017 毕业设计</div>
	</div>
